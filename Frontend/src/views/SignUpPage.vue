...
const handleSubmit = () => {
  ...
  requestAPI
    .post(`${API_AUTHENTICATION.REGISTER}`, model.value)
    .then(({ data: response }) => {
            ...
            <div class="card">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="card-text">
                  ...
                  <div class="mt-4">
                    <input class="form-control rounded-5" type="password" placeholder="Re-entered password" v-model.trim="model.confirmPassword" @keydown.enter="handleSubmit">
                  </div>
                  <div class="mt-4">
